...
at lower ($m\leq15\msun$) masses when compared to predictions from the isolated channel \bruce{cite}. BBHs that form near active galactic nuclei (AGN) can preferentially produce higher 
