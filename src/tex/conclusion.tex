...
with gravitational waves, along with the associated open source software \textsc{GWInferno} (\href[git.ligo.org/bruce.edelman/gwinferno]{https://git.ligo.org/bruce.edelman/gwinferno}) that implements the models 
