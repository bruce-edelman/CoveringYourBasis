...
\begin{figure*}[ht!] \label{fig:mass_distribution}
    \begin{centering}
        \includegraphics[width=0.8\textwidth]{figures/mass_distribution_plot.pdf}
...
\begin{figure} \label{fig:iid_spinmag_dist}
    \includegraphics[width=0.4\textwidth]{figures/iid_spinmag.pdf}
...
\begin{figure} \label{fig:ind_spinmag_dist}
    \includegraphics[width=0.4\textwidth]{figures/ind_spinmag.pdf}
...
\begin{figure} \label{fig:iid_spintilt_dist}
    \includegraphics[width=0.4\textwidth]{figures/iid_spintilt.pdf}
...
\begin{figure} \label{fig:ind_spintilt_dist}
    \includegraphics[width=0.4\textwidth]{figures/ind_spintilt.pdf}
...
\begin{figure} \label{fig:chieff_dist}
    \includegraphics[width=0.4\textwidth]{figures/chi_eff.pdf}
