...
We find a local ($z=0$) merger rate of $\mathcal{R}_0 = $\result{$\CIPlusMinus{\macros[BSplineIIDCompSpins][local_rate]}$} using the B-Spline modulation model 
which compares to $\mathcal{R}_0 = $\result{$\CIPlusMinus{\macros[PLPeak][local_rate]}$} for the GWTC-3 result. 
