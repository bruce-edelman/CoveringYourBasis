...
distributions in figure \ref{fig:ind_spintilt_dist}. The primary and secondary orientation distibutions do not agree as well as the magnitude 
distibutions did in figure \ref{fig:ind_spinmag_dist}, and the PPDs look to peak at different values, but the wide uncertainties still are 
